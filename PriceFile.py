...
txt_fries = Entry(left1, font=('arial', 16, 'bold'), textvariable=fries_inp_p, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
...
txt_Sandwich = Entry(left1, font=('arial', 16, 'bold'), textvariable=Sandwich_inp_p, bd=10, insertwidth=4,
...
txt_burger = Entry(left1, font=('arial', 16, 'bold'), textvariable=burger_inp_p, bd=10, insertwidth=4, bg="powder blue",
                   justify='right')
...
txt_drinks = Entry(left1, font=('arial', 16, 'bold'), textvariable=drinks_inp_p, bd=10, insertwidth=4, bg="powder blue",
                   justify='right')
...
txt_Pasta = Entry(left1, font=('arial', 16, 'bold'), textvariable=Pasta_inp_p, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
...
txt_Tacos = Entry(left1, font=('arial', 16, 'bold'), textvariable=Tacos_inp_p, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
txt_Tacos.grid(row=6, column=1)

btn_update = Button(left1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10, text="Update",
                    bg="powder blue", command=update)
btn_update.grid(row=7, column=1)

btn_reset1 = Button(left1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10, text="Reset",
                    bg="powder blue", command=reset1)
btn_reset1.grid(row=7, column=2)

btn_exit1 = Button(left1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10, text="Exit",
                   bg="powder blue", command=qexit1)
btn_exit1.grid(row=7, column=3)

btn_print = Button(left1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10, text="print",
                   bg="powder blue", command=printfn)
btn_print.grid(row=7, column=4)

btn_back = Button(left1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10, text="Back",
                  bg="powder blue", command=backfn)
