...
label_info = Label(top, font=('arial', 50, 'bold'), text="Restaurant Bill Calculator-Ver.2.0", fg="steel blue", bd=10,
                   anchor='w')
...
txt = Entry(right, font=('arial', 20, 'bold'), textvariable=txt_inp, bd=30, insertwidth=4, bg="powderblue",
            justify='right')
...
txt_fries = Entry(left, font=('arial', 16, 'bold'), textvariable=fries_inp, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
...
txt_Sandwich = Entry(left, font=('arial', 16, 'bold'), textvariable=Sandwich_inp, bd=10, insertwidth=4,
...
txt_Pasta = Entry(left, font=('arial', 16, 'bold'), textvariable=Pasta_inp, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
...
txt_Tacos = Entry(left, font=('arial', 16, 'bold'), textvariable=Tacos_inp, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
